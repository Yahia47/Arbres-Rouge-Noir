...
//		};
        ...
        JLabel title = new JLabel("<html>Visualisation Arbre <span 		style='color:red;'>Rouge</span>-<span style='color:black;'>Noir</span></html>");
        title.setForeground(Color.BLACK);
        title.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 20));
        title.setBounds(250, 25, 400, 40);
        header.add(title);
        ...
        footer.add(lbl_text);
                ...
                lbl_text.setText("Entrer la valeur � ajouter :");
    ...
    private void btn_suppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suppActionPerformed
        addORsupp = 2;
        lbl_text.setText("Entrer la valeur � supprimer :");
                ...
                try {
                    if (txtVal.getText().trim().length() != 0) {
                       ...
                       centre.paint(container.getGraphics());
                        ...
                        JOptionPane.showMessageDialog(this, "Merci de saisir la valeur � jouter ");
                        txtVal.requestFocus();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
